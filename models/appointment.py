...
class Appointment(Base):
    ...
    consultant_joined_at = Column(DateTime(timezone=True), nullable=True)
    user_joined_at = Column(DateTime(timezone=True), nullable=True)
    attendance_status = Column(String(50), nullable=True, default="scheduled")
    no_show_party = Column(String(20), nullable=True)
    no_show_detected_at = Column(DateTime(timezone=True), nullable=True)

...
def seed_consultants():
    ...
    try:
        ...
        advisors = [
            {
                "email": "consultant2@platform.com",
                "password": "Password123!",
                "full_name": "أ. عبدالرحمن حسين",
                "phone": "+962790000002",
                "spec_id": income_tax_spec.id,
                "bio": "مستشار ضريبي بخبرة تزيد عن 20 سنة في الاستشارات الضريبية، تدقيق الحسابات، والاعتراضات لدى دائرة ضريبة الدخل والمبيعات الأردنية.",
                "years_exp": 20,

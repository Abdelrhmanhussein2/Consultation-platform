...
export default function UserSettingsNotificationsTab({
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '16px' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: '12.5px', color: '#64748B', lineHeight: '1.5' }}>
                تذكير بمواعيد الجلسات الاستشارية وتأكيد الحجوزات
              </div>
            </div>
          </div>
          ...
          {appointmentReminders && (
            ...
            >
              ...
              <select
                ...
                onChange={(e) => setReminderMinutes && setReminderMinutes(e.target.value)}
                style={{
                  padding: '7px 14px',
                  borderRadius: '8px',
        ...
        <div style={{ padding: '20px 0', borderBottom: '1px solid #F1F5F9' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '16px' }}>
            <ToggleSwitch
              id="toggle-invoice-notif"
              checked={invoiceUpdates}
              onChange={(val) => setInvoiceUpdates(val)}
            />
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: '15px', fontWeight: '900', color: '#0F172A', marginBottom: '3px' }}>
                تحديثات الفواتير
              ...
              <div style={{ fontSize: '12.5px', color: '#64748B', lineHeight: '1.5' }}>
                إشعار عند صدور أو دفع فاتورة أو تجديد الاشتراك
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={{ padding: '20px 0 26px 0' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '16px' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: '12.5px', color: '#64748B', lineHeight: '1.5' }}>
                عروض وخصومات وأخبار المنصة والميزات المضافة
              </div>
            </div>
          </div>
        </div>

    ...
    <>
      ...
      <div className="user-subs-container">
        ...
        <div className="subs-header-row">
          <div>
            <h1 className="subs-page-title">باقات واشتراكات المستشارين</h1>
          ...
          <div className="active-sub-card">
            ...
            {activeSub.is_expiring_soon && (
              <div className="expiring-soon-banner">
                <div className="expiring-banner-content">
                  <div>
                    <div className="expiring-title">تنبيه انتهاء باقة المستشار القريب</div>
                ...
                >
                  {subscribing === 'renew' ? 'جاري التجديد...' : 'تجديد الباقة الآن بنفس الخدمات'}
                </button>
              </div>
            )}
            ...
            <div className="active-sub-actions">
              <button
                ...
                disabled={subscribing === 'renew'}
              >
                {subscribing === 'renew' ? 'جاري التجديد...' : 'طلب تجديد الباقة الحالية بنفس الخدمات'}
              </button>
              <button
                type="button"
                ...
                >
                  ...
                  <div className="card-cta-wrapper">
                    <button
                      ...
                      disabled={isCurrent || isPending || subscribing === plan.id}
                    >
                      {isCurrent ? 'باقتك الحالية النشطة' : isPending ? 'طلبك قيد المراجعة' : subscribing === plan.id ? 'جاري إرسال الطلب...' : 'طلب الاشتراك والترقية'}
                    </button>
                  </div>
            ...
            <div className="subs-modal-card">
              ...
              <div className="subs-modal-body">
                ...
                <div className="modal-field">
                  <label>طريقة الدفع / الاقتطاع:</label>
                  <select
                    value={paymentMethod}
                    onChange={(e) => setPaymentMethod(e.target.value)}
                  >
                    <option value="اقتطاع من الأرباح المكتسبة القادمة">اقتطاع من الأرباح المكتسبة القادمة</option>
              ...
              <div className="subs-modal-foot">
                <button
                  ...
                  disabled={subscribing === selectedPlanModal.id}
                >
                  {subscribing === selectedPlanModal.id ? 'جاري إرسال الطلب...' : 'تأكيد وإرسال الطلب للإدارة'}
                </button>
                <button
                  type="button"

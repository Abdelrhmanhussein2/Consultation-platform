        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginBottom: '28px' }}>
          ...
          >
            <div>
              ...
              <div style={{ fontSize: '11.5px', color: '#64748B', marginTop: '2px' }}>
                اختيار عملة عرض الأسعار والأتعاب والتحصيلات
              </div>
            </div>
            <div style={{ display: 'flex', justifyContent: 'flex-start' }}>
              <select
          ...
          >
            <div>
              ...
              <div style={{ fontSize: '11.5px', color: '#64748B', marginTop: '2px' }}>
                المنطقة الزمنية المعتمدة لجدول مواعيدك وجلسات الاستشارات المباشرة
              </div>
            </div>
            <div style={{ display: 'flex', justifyContent: 'flex-start' }}>
              <select
          ...
          >
            <div>
              ...
              <div style={{ fontSize: '11.5px', color: '#64748B', marginTop: '2px' }}>
                طريقة صياغة وعرض التواريخ في الجداول والتقارير المالية
              </div>
            </div>
            <div style={{ display: 'flex', justifyContent: 'flex-start' }}>
              <select
        ...
        >
          ...
          >
            <div style={{ background: '#FFFFFF', padding: '10px 14px', borderRadius: '10px', border: '1px solid #E2E8F0' }}>
              <span style={{ fontSize: '11px', color: '#64748B', display: 'block' }}>عينة أتعاب استشارة (80 د.أ):</span>
